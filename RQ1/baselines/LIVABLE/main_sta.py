...
if __name__ == '__main__':
    ...
    print(os.path.join(input_dir, 'diverse-train-v0.json'))
    print(os.path.join(input_dir, 'diverse-valid-v0.json'))
    print(os.path.join(input_dir, 'diverse-test-v0.json'))
    dataset = DataSet(train_src=os.path.join(input_dir, 'diverse-train-v0.json'),
                      valid_src=os.path.join(input_dir, 'diverse-valid-v0.json'),
                      test_src=os.path.join(input_dir, 'diverse-test-v0.json'),
    ...
    num_classes = 31
    num_class_list = [917, 1140, 469, 383, 205, 275, 249, 134, 164, 110, 138, 109, 80, 95, 75, 49, 32, 34, 31, 26, 26,
                      24, 20, 18, 12, 16, 10, 12, 25, 13, 133]
    ...
    train(model=model, dataset=dataset, epoches=50, dev_every=len(dataset.train_batches),
          ...
          save_path=os.path.join(new_model_dir, cfg.MODELNAME), max_patience=20, log_every=5)